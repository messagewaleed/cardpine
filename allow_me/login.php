        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form id="login_form" data-parsley-validate="" >
              ...
              <div>
                <input type="text" name="username" class="form-control parsley-success" data-parsley-id="101" placeholder="Username" required="" />
                <ul class="parsley-errors-list" id="parsley-id-101"></ul>
              </div>
              <div>
                <input type="password" name="password" class="form-control parsley-success" data-parsley-id="102" placeholder="Password" required="" /><ul class="parsley-errors-list" id="parsley-id-102"></ul>
              </div>
              <div>
